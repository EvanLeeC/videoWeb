...
public class Setting implements Serializable {
	...
	/** 默认活动图片(大) */
	private String defaultLargeActivityImage;

	/** 默认活动图片(小) */
	private String defaultMediumActivityImage;
	
	/** 默认Banner图片(大) */
	private String defaultLargeBannerImage;

	/** 默认Banner图片(小) */
	private String defaultMediumBannerImage;
	
	/** 默认购物车图片(大) */
	private String defaultLargeCartImage;

	/** 默认购物车图片(小) */
	private String defaultMediumCartImage;
	
	/** 默认商品详情图片(大) */
	private String defaultLargeProductDetailImage;

	/** 默认商品详情图片(小) */
	private String defaultMediumProductDetailImage;

	/** 默认商品列表图片(大) */
	private String defaultLargeProductListImage;

	/** 默认商品列表图片(小) */
	private String defaultMediumProductListImage;
	
	/** 默认特惠小图片(大) */
	private String defaultLargeRecommendImage;

	/** 默认特惠小图片(小) */
	private String defaultMediumRecommendImage;
	
	/** 默认特惠图片(大) */
	private String defaultLargeSpecialsImage;

	/** 默认特惠图片(小) */
	private String defaultMediumSpecialsImage;
	 ...
	 *            网站网址
	 */
	public void setSiteUrl2(String siteUrl2) {
		this.siteUrl2 = StringUtils.removeEnd(siteUrl2, "/");
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultLargeActivityImage() {
		return defaultLargeActivityImage;
	}

	/**
	 * 设置默认活动图片（大）
	 * 
	 * @param defaultLargeActivityImage void
	 */
	public void setDefaultLargeActivityImage(String defaultLargeActivityImage) {
		this.defaultLargeActivityImage = defaultLargeActivityImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultMediumActivityImage() {
		return defaultMediumActivityImage;
	}

	/**
	 * 设置默认活动图片（小）
	 * 
	 * @param defaultMediumActivityImage void
	 */
	public void setDefaultMediumActivityImage(String defaultMediumActivityImage) {
		this.defaultMediumActivityImage = defaultMediumActivityImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultLargeBannerImage() {
		return defaultLargeBannerImage;
	}

	/**
	 * 设置默认Banner图片（大）
	 * 
	 * @param defaultLargeBannerImage void
	 */
	public void setDefaultLargeBannerImage(String defaultLargeBannerImage) {
		this.defaultLargeBannerImage = defaultLargeBannerImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultMediumBannerImage() {
		return defaultMediumBannerImage;
	}

	/**
	 * 设置默认Banner图片（小）
	 * 
	 * @param defaultMediumBannerImage void
	 */
	public void setDefaultMediumBannerImage(String defaultMediumBannerImage) {
		this.defaultMediumBannerImage = defaultMediumBannerImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultLargeCartImage() {
		return defaultLargeCartImage;
	}

	/**
	 * 设置默认购物车图片（大）
	 * 
	 * @param defaultLargeCartImage void
	 */
	public void setDefaultLargeCartImage(String defaultLargeCartImage) {
		this.defaultLargeCartImage = defaultLargeCartImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultMediumCartImage() {
		return defaultMediumCartImage;
	}

	/**
	 * 设置默认购物车图片（小）
	 * 
	 * @param defaultMediumCartImage void
	 */
	public void setDefaultMediumCartImage(String defaultMediumCartImage) {
		this.defaultMediumCartImage = defaultMediumCartImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultLargeProductDetailImage() {
		return defaultLargeProductDetailImage;
	}

	/**
	 * 设置默认商品详情图片（大）
	 * 
	 * @param defaultLargeProductDetailImage void
	 */
	public void setDefaultLargeProductDetailImage(
			String defaultLargeProductDetailImage) {
		this.defaultLargeProductDetailImage = defaultLargeProductDetailImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultMediumProductDetailImage() {
		return defaultMediumProductDetailImage;
	}

	/**
	 * 设置默认商品详情图片（小）
	 * 
	 * @param defaultMediumProductDetailImage void
	 */
	public void setDefaultMediumProductDetailImage(
			String defaultMediumProductDetailImage) {
		this.defaultMediumProductDetailImage = defaultMediumProductDetailImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultLargeProductListImage() {
		return defaultLargeProductListImage;
	}

	/**
	 * 设置默认商品列表图片（大）
	 * 
	 * @param defaultLargeProductListImage void
	 */
	public void setDefaultLargeProductListImage(String defaultLargeProductListImage) {
		this.defaultLargeProductListImage = defaultLargeProductListImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultMediumProductListImage() {
		return defaultMediumProductListImage;
	}

	/**
	 * 设置默认商品列表图片（小）
	 * 
	 * @param defaultMediumProductListImage void
	 */
	public void setDefaultMediumProductListImage(
			String defaultMediumProductListImage) {
		this.defaultMediumProductListImage = defaultMediumProductListImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultLargeRecommendImage() {
		return defaultLargeRecommendImage;
	}

	/**
	 * 设置默认特惠小图片（大）
	 * 
	 * @param defaultLargeRecommendImage void
	 */
	public void setDefaultLargeRecommendImage(String defaultLargeRecommendImage) {
		this.defaultLargeRecommendImage = defaultLargeRecommendImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultMediumRecommendImage() {
		return defaultMediumRecommendImage;
	}

	/**
	 * 设置默认特惠小图片（小）
	 * 
	 * @param defaultMediumRecommendImage void
	 */
	public void setDefaultMediumRecommendImage(String defaultMediumRecommendImage) {
		this.defaultMediumRecommendImage = defaultMediumRecommendImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultLargeSpecialsImage() {
		return defaultLargeSpecialsImage;
	}

	/**
	 * 设置默认特惠图片（大）
	 * 
	 * @param defaultLargeSpecialsImage void
	 */
	public void setDefaultLargeSpecialsImage(String defaultLargeSpecialsImage) {
		this.defaultLargeSpecialsImage = defaultLargeSpecialsImage;
	}
	...
	@NotEmpty
	@Length(max = 200)
	public String getDefaultMediumSpecialsImage() {
		return defaultMediumSpecialsImage;
	}

	/**
	 * 设置默认特惠图片（小）
	 * 
	 * @param defaultMediumSpecialsImage void
	 */
	public void setDefaultMediumSpecialsImage(String defaultMediumSpecialsImage) {
		this.defaultMediumSpecialsImage = defaultMediumSpecialsImage;
	}
	...
	public BigDecimal setScale(BigDecimal amount) {
        ...
        BigDecimal scaled = amount.setScale(getPriceScale() + 1, roundingMode);
		return scaled.setScale(getPriceScale(), roundingMode);
	}
}