...
import net.video.CommonAttributes;
import net.video.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File shopxxXmlFile = new ClassPathResource(CommonAttributes.VIDEO_XML_PATH).getFile();
